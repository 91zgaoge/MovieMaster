...
type
  TForm1 = class(TForm)
    ...
    mmoLog1: TMemo;
    mmoLog: TMemo;
    pbFileSent: TProgressBar;
    pbFileReceived: TProgressBar;
...
begin
  ...
  pbFileReceived.Position := FMessage.FilePosition;
  pbFileReceived.Max := FMessage.FileSize;
end;
...
begin
 ...
 form1.pbFileSent.Position := FMessage.FilePosition;
form1.pbFileSent.Max := FMessage.FileSize;
end;

procedure TForm1.DoLog;
begin
  form1.mmoLog1.Lines.Add(FormatDateTime('hh:nn:ss', Now) + ': ' + FText);
end;
